...
const PlayerControl = () => {
    ...
    const next = () => {
        if (audio.currentTime + 15 < duration) {
            ...
            //there must come another track I have added it 0 because there is not other song
            audio.currentTime = 0;
        }
    }
            ...
            <div className="controls">
                ...
                <div className={styles.player}>
                    ...
                    <button onClick={togglePlayPause}>
                        {isPlaying ? <svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" fill="none">
